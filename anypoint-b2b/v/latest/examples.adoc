...
image::PromoteIDsOffCertsOn.png[img-PromoteIDsOffCertsOn, title="Promotion with IDs off and Certificates On"]



[[img-promote-keep-certs]]

image::promote-keep-certs.png[img-promote-keep-certs, title="promote-keep-certs"]
