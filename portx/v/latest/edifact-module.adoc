...
* Support for many link:/portx/supported-edi-document-types[common EDIFACT versions] out of the box
...
If you wish, you can also define your own schemas from scratch. See the link:/portx/edi-schema-language-reference[EDI Schema Language Reference] for more details.
