...
Document:: As created in link:/portx/document-types[Document Types]
Document Map:: As created in link:/portx/maps[Maps]
Endpoint:: As created in link:/portx/endpoints[Endpoints]
