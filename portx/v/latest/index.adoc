...
For more information, see link:/portx/transaction-monitoring[Transaction Monitoring].
...
For more information, see link:/portx/partner-configuration[Partner Configuration].

== Administration

Your company is considered a trading partner in that all the settings you can configure for a trading partner, you can configure for your company. However, PortX also offers other settings that apply only to your company, such as link:/portx/security[security] settings.

For more information, see link:/portx/administration[Administration].
...
In the most common scenario, PortX is used in conjunction with Anypoint Studio, Partner Manager Connector, and other MuleSoft connectors. Find information about this and other PortX use cases in link:/portx/examples[Examples].
...
. To configure or edit the configuration of a trading partner, see link:/portx/partner-configuration[Partner Configuration].
+
To edit or configure settings for your company, see link:/portx/administration[Administration].
...
Use link:/access-management/[Anypoint Access Management] to create PortX  link:/access-management/users[users] and manage their link:/access-management/roles[roles].
