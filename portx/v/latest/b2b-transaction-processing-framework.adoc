...
link:/anypoint-b2b/anypoint-partner-manager[PortX] (PortX).
...
=== Document Type
link:/anypoint-b2b/document-types[Document Types] are configured in PortX. A given document type
...
The PortX user interface enables link:/anypoint-b2b/partner-configuration[partner configuration], link:/anypoint-b2b/administration[administration] and detailed link:/anypoint-b2b/transaction-monitoring[transaction monitoring].
