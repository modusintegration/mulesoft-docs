...
. In the *CONFIGURATION* section of the left-hand navigation pane on the <<partner-configuration.adoc#img-company-information, Company Information Page>>, click *Document Types*.
+
...
image::document-edit.png[img-document-edit, title="Existing Document Page"]
...
* *Company name* (see link:/portx/partners[Partners] and link:/portx/company-information[Company Information])
* *Standard* (see <<Format>>)
* *Version* (see <<Format>>)
...
|Select either of these checkboxes in order to use the values selected in the corresponding sections of link:/portx/x12-settings[x12-Settings].
...
|Select this checkbox in order to use the values selected in the corresponding sections of link:/portx/csv-settings[CSV-Settings].
...
Valid values:: link:/portx/glossary#sects[Standard PortX field format]
+
