...
. After you enter a contact type, you can enter the following contact-specific information. All fields are link:/anypoint-b2b/glossary#sects[standard PortX field format].
