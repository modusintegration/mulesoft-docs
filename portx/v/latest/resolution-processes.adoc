...
for link:/portx/b2b-transaction-processing-framework#document-type[document types], link:/portx/b2b-transaction-processing-framework#endpoints[endpoints], and link:/portx/routes[routes]. For example, you can configure
