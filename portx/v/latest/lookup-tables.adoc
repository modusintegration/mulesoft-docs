...
. In the *ADMINISTRATION* section of the left-hand navigation pane on the <<partner-configuration.adoc#img-company-information, Company Information Page>>, click *Lookup Tables Admin*.
+
The <<img-lookup-tables-admin>> appears.

[[img-lookup-tables-admin]]

image::lookup-tables-admin.png[img-lookup-tables-admin, title="Lookup Tables Admin Page"]
...
This section shows you how to use the PortX user interface to create a lookup table. Alternatively, you can create a lookup table through calls to the link:/portx/anypoint-partner-manager-api[PortX API]; see link:/portx/lookup-tables-programmatic[Create a Lookup Table]. See link:/portx/lookup-tables-programmatic[Create a Lookup Table] also for instructions for querying a table.
...
image::lookup-table.png[img-lookup, title="Lookup Table Page"]
...
. In the *ADMINISTRATION* section of the left-hand navigation pane on the <<partner-configuration.adoc#img-company-information, Company Information Page>>, click *Lookup Tables Data Entry*.
+
The <<img-lookup-tables-data-entry>> appears.

[[img-lookup-tables-data-entry]]

image::lookup-tables-data-entry.png[img-lookup-tables-data-entry, title="Lookup Tables Data Entry Page"]
