...
NOTE: Your company may have been set up during the provisioning process. If so, its name appears at the top of the Name list on the Partner Configuration Page, identified as *Your company*.
...
* link:/portx/lookup-tables[Lookup Tables Administration]
