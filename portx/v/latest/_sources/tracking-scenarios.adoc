...
This section identifies scenarios in which PortX is useful to track B2B exchanges. A basic knowledge of PortX is assumed; see  link:/anypoint-b2b/anypoint-partner-manager[PortX] for more information.
