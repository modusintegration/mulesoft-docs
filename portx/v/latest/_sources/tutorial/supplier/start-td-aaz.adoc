. In the *CONFIGURATION* section of the left-hand navigation pane on the xref:img-endpoints[] (or any other PortX Configuration page), click *Transaction Designer*.
+
