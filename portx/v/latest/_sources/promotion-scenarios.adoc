...
This section identifies common scenarios for promoting partners from one environment to another. For more information, see  link:/portx/partner-configuration#promoting-a-partner[Promoting a Partner].
